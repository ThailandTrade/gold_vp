...
memes exits — partout.
(Conflict filter retire 2026-04-29 — SHORT/LONG simultanes autorises.)
"""
import numpy as np
import pandas as pd
...
def collect_trades(candles, daily_atr, global_atr, trading_days_list, portfolio, sym_exits, date_filter=None):
    ...
    # Phase 2: simuler exits (conflict filter retire 2026-04-29 - on autorise SHORT et LONG simultanes)
