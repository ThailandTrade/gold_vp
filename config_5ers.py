...
INSTRUMENTS = {
    ...
    #     'risk_pct': 0.0005,
    #     'portfolio': [
    #         'ALL_FIB_618','LON_GAP','ALL_NR4','ALL_STOCH_PIVOT','ALL_MTF_BRK',
    ...
    #         'D8','LON_TOKEND','TOK_PREVEXT','NY_LONEND','ALL_STOCH_RSI','ALL_MACD_MED_SIG',
    #     ],
    ...
    #         'ALL_ELDER_BULL','ALL_ADX_RSI50','ALL_MACD_STD_SIG','TOK_FADE',
    #         'ALL_FISHER_9','ALL_INSIDE_BRK','TOK_WILLR','ALL_BB_TIGHT',
    #         'TOK_BIG','ALL_RSI_DIV','ALL_DC10','ALL_DC10_EMA','TOK_PREVEXT',
    #     ],
    ...
    #     'risk_pct': 0.0005,
    #     'portfolio': [
    #         'D8','ALL_HMA_CROSS','ALL_SUPERTREND','TOK_NR4','TOK_FADE',
    #         'ALL_RSI_50','ALL_PIVOT_BOUNCE','ALL_MSTAR','IDX_PREV_HL',
    #         'ALL_MACD_HIST','ALL_FVG_BULL','IDX_NY_MOM','ALL_NR4',
    #         'TOK_PREVEXT','ALL_ELDER_BULL','LON_BIGGAP','ALL_DC50',
    ...
    #         'ALL_DC50','ALL_RSI_EXTREME','ALL_FVG_BULL','LON_PREV',
    ...
    #         'IDX_TREND_DAY','LON_BIGGAP','IDX_LATE_REV','ALL_MACD_DIV',
    #         'IDX_CONSEC_REV','LON_GAP','ALL_HAMMER','TOK_NR4','ALL_MSTAR','LON_PREV',
    #     ],
