"""
Config Pepperstone multi-TF -- 1h regenere 2026-04-30 (find_winners v3, 33 syms / 151 strats).
15m et 4h conserves du run 2026-05-03.
Capital $200, risk 0.5%, server UTC+3.
Schema: ALL_INSTRUMENTS[sym][tf] = {'risk_pct': ..., 'portfolio': [...]}

Pipeline find_winners:
- 15m: n>=80
- 1h:  n>=60   <- run v3 2026-04-30 (incluant 11 cryptos, DOGEUSD=0)
- 4h:  n>=40
