"""
Paper Trading FTMO - 8 strats.
Usage: python live_paper_ftmo.py [--reset]
"""
...
RISK_PCT = 0.01
CHECK_INTERVAL = 1
LOG_FILE = "paper_ftmo.json"
from strats import SL, ACT, TRAIL, STRAT_NAMES, STRAT_SESSION, detect_all
from config_ftmo import PORTFOLIO as STRATS
...
logging.basicConfig(level=logging.INFO, format='%(asctime)s | %(message)s',
    ...
    handlers=[logging.StreamHandler(),
              logging.FileHandler('paper_ftmo.log', encoding='utf-8')])
