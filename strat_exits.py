...
STRAT_EXITS[('pepperstone', 'AUS200', '15m')] = {
    ...
    'ALL_MACD_HIST': ('TPSL', 2.5, 2.0, 0.0),
    'ALL_PSAR_EMA': ('TRAIL', 2.0, 0.5, 0.75),
...
STRAT_EXITS[('pepperstone', 'GER40', '15m')] = {
    'ALL_EMA_513': ('TPSL', 3.0, 2.5, 0.0),
    'ALL_EMA_821': ('TRAIL', 3.0, 1.0, 0.3),
    'ALL_MACD_FAST_ZERO': ('TPSL', 3.0, 2.5, 0.0),
}

STRAT_EXITS[('pepperstone', 'HK50', '15m')] = {
    'IDX_TREND_DAY': ('TPSL', 3.0, 5.0, 0.0),
}
