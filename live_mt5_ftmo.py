...
parser.add_argument('--magic', type=int, default=20000001, help='Magic number MT5')
...
logging.basicConfig(level=logging.INFO, format='%(asctime)s | %(message)s',
    ...
    handlers=[logging.StreamHandler(),
              logging.FileHandler('live_mt5_ftmo.log', encoding='utf-8')])
log = logging.getLogger('mt5live')

# ── STATE (persistant) ───────────────────────────────

STATE_FILE = 'live_mt5_ftmo_state.json'
